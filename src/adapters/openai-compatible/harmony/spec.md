...
### [Chat conversation format](#chat-conversation-format)
...
### [System message format](#system-message-format)
...
#### [Example system message](#example-system-message)
...
### [Developer message format](#developer-message-format)
...
#### [Defining available tools](#defining-available-tools)
...
#### [Receiving tool calls](#receiving-tool-calls)
